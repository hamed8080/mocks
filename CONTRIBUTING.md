...
Thank you for considering contributing to Mocks.

Please know that everyone is welcome to contribute to Mocks.
...
Mocks is an open source project and we encourage contributions
from the community.

### Contributing Code and Documentation

Before contributing code or documentation to Mocks,
we encourage you to first open a 
[GitHub issue](https://github.com/hamed8080/mocks/issues/new/choose) 
...
All changes to Mocks source must go through the PR review process before
...
Mocks is a Swift package. If you're new to Swift package manager,
...
1. Checkout this repository using:
    ...
    ```bash
    git clone git@github.com:hamed8080/mocks.git
    ```
...
4. Build Mocks from the command line by running:
